...
package com.fwheart.androidsnippet.layout;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int iconBottom = 10;
    private int textBottom = 10;
    private Mode tabMode = Mode.TextIcon;
    private Mode[] tabModes = Mode.values();
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray tArr = context.obtainStyledAttributes(attrs,R.styleable.TabBar,defStyleAttr,0);
        initAttr(tArr);
    ...
    private void initAttr(TypedArray tArr){
        itemPadding = tArr.getDimensionPixelSize(R.styleable.TabBar_tab_item_padding, itemPadding);
        itemPaddingTop = tArr.getDimensionPixelSize(R.styleable.TabBar_tab_item_padding_top, itemPaddingTop);
        itemPaddingBottom = tArr.getDimensionPixelSize(R.styleable.TabBar_tab_item_padding_bottom, itemPaddingBottom);
        itemPaddingLeft = tArr.getDimensionPixelSize(R.styleable.TabBar_tab_item_padding_left, itemPaddingLeft);
        itemPaddingRight = tArr.getDimensionPixelSize(R.styleable.TabBar_tab_item_padding_right, itemPaddingRight);
        itemPaddingHorizontal = tArr.getDimensionPixelSize(R.styleable.TabBar_tab_item_padding_horizontal, itemPaddingHorizontal);
        itemPaddingVertical = tArr.getDimensionPixelSize(R.styleable.TabBar_tab_item_padding_vertical, itemPaddingVertical);
        itemTextSizeSp = tArr.getInteger(R.styleable.TabBar_tab_title_textSize,itemTextSizeSp);
        titleOffset = tArr.getDimensionPixelSize(R.styleable.TabBar_tab_title_offset, titleOffset);
        tabMode = tabModes[tArr.getInteger(R.styleable.TabBar_tab_mode,tabMode.ordinal())];
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabTitleView == null && LinearLayout.class.isInstance(tabView)) {
